...
entropy to a weak secret. Only the authenticated, versioned envelope format is
supported; records from earlier pre-release implementations must be recreated.
