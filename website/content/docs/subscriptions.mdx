...
For complete production SSE endpoints, worker-pool partitioning, failover leader election, and disaster-recovery runbooks, see the [Event Streaming & Resilient Consumer Playbook](/docs/playbook-sse-and-consumer-scaling).
