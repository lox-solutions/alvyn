...
export default function HomePage() {
    return (
        <div
            className="flex flex-col items-center flex-1 overflow-hidden bg-fd-background text-fd-foreground selection:bg-zinc-800">
            {/* ── HERO SECTION ─────────────────────────────────────────────────── */}
            <section
                className="relative w-full min-h-[92vh] flex flex-col items-center justify-center px-6 text-center py-24 overflow-hidden">
            ...
            <span
                className="text-xs font-mono font-medium uppercase tracking-[0.2em] text-fd-muted-foreground mb-4 flex items-center gap-2">
            ...
            <span
                className="text-xs font-mono font-medium uppercase tracking-[0.2em] text-fd-muted-foreground mb-3 block">
          ...
          <span
                        ...
                        {[
                            ...
                            >
                                <div className="flex items-center justify-between mb-6">
                                    <div
                                        className="p-3 rounded-2xl bg-fd-secondary border border-fd-border text-fd-secondary-foreground group-hover:text-fd-foreground group-hover:border-fd-accent transition-all duration-300 shadow-sm">
                                        <Icon size={18}/>
                                    </div>
                                    <span
                                        className="text-xs font-mono font-bold tracking-widest text-fd-muted-foreground group-hover:text-fd-secondary-foreground transition-all duration-300">
                    {n}
                  </span>
                                </div>
            ...
            <section
                className="relative w-full border-t border-fd-border overflow-hidden bg-gradient-to-b from-transparent to-fd-background">
